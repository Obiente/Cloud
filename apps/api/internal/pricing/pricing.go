...
var (
	...
	defaultPricing = PricingModel{
		CPUCostPerCoreSecond:    0.0001,     // $0.0001 per core-second = $0.36 per core-hour
		MemoryCostPerByteSecond: 0.00000001, // $0.00000001 per byte-second = $0.000000036 per byte-hour
		BandwidthCostPerByte:    0.00000001, // $0.00000001 per byte = $0.01 per GB
		StorageCostPerByteMonth: 0.00000001, // $0.00000001 per byte-month = $0.01 per GB-month
	}
