...
const sftpAPIKeysTable = "sftp_service_api_keys"
...
type APIKey struct {
	...
	DeploymentID   *string        `gorm:"type:text;index" json:"deployment_id,omitempty"`
	GameServerID   *string        `gorm:"type:text;index" json:"game_server_id,omitempty"`
	...
	ResourceType   string         `gorm:"type:text;not null;index:idx_sftp_api_key_resource" json:"resource_type"`
	ResourceID     string         `gorm:"type:text;not null;index:idx_sftp_api_key_resource" json:"resource_id"`
