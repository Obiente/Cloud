...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/obiente/cloud/apps/shared/proto/obiente/cloud/audit/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AuditServiceName = "obiente.cloud.audit.v1.AuditService"
)
...
// AuditServiceClient is a client for the obiente.cloud.audit.v1.AuditService service.
...
// NewAuditServiceClient constructs a client for the obiente.cloud.audit.v1.AuditService service. By
...
func NewAuditServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuditServiceClient {
	...
	auditServiceMethods := v1.File_obiente_cloud_audit_v1_audit_service_proto.Services().ByName("AuditService").Methods()
	return &auditServiceClient{
		...
		getAuditLog: connect.NewClient[v1.GetAuditLogRequest, v1.GetAuditLogResponse](
			...
			connect.WithSchema(auditServiceMethods.ByName("GetAuditLog")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
// AuditServiceHandler is an implementation of the obiente.cloud.audit.v1.AuditService service.
...
func NewAuditServiceHandler(svc AuditServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/obiente.cloud.audit.v1.AuditService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditServiceHandler) GetAuditLog(context.Context, *connect.Request[v1.GetAuditLogRequest]) (*connect.Response[v1.GetAuditLogResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("obiente.cloud.audit.v1.AuditService.GetAuditLog is not implemented"))
}
