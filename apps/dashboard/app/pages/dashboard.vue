      ...
      <OuiFlex justify="between" align="center" wrap="wrap" gap="lg">
        <OuiStack gap="xs" class="flex-1">
          ...
          <OuiText color="secondary"
            >A quick glance at your cloud resources and recent
            activity.</OuiText
          >
        </OuiStack>
          ...
          <OuiCardHeader>
            <OuiFlex align="center" justify="between">
              ...
              <OuiBadge :variant="allHealthy ? 'success' : 'warning'">{{
                allHealthy ? "All systems nominal" : "Attention required"
              }}</OuiBadge>
            </OuiFlex>
          </OuiCardHeader>
          <OuiCardBody>
            ...
            <template v-else>
              <OuiFlex gap="sm" wrap="wrap" class="mb-3">
                ...
                <OuiBadge variant="warning"
                  >Building: {{ buildingCount }}</OuiBadge
                >
                <OuiBadge variant="secondary"
                  >Stopped: {{ stoppedCount }}</OuiBadge
                >
                <OuiBadge variant="success"
                  >Running: {{ runningCount }}</OuiBadge
                >
              </OuiFlex>
