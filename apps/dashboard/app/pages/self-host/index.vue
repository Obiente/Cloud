<template>
  <OuiStack gap="2xl">
    <!-- Page Header -->
    <OuiStack gap="xs">
      <OuiText tag="h1" size="xl" weight="semibold"
        >Self-Hosted DNS Delegation</OuiText
      >
      <OuiText size="sm" color="tertiary">
        Manage DNS delegation for your self-hosted Obiente Cloud instance. Use
        the main
        <OuiCode code="my.obiente.cloud" language="text" padding="xs" inline />
        DNS service without exposing DNS port 53 locally.
      </OuiText>
    </OuiStack>
    ...
    <OuiCard>
      <OuiCardHeader>
        <OuiStack gap="xs">
          ...
          <OuiText size="sm" color="tertiary">
            DNS delegation is managed per organization. Select the organization
            that owns your self-hosted instance.
          </OuiText>
        </OuiStack>
      </OuiCardHeader>
      <OuiCardBody>
      ...
      <OuiCard variant="outline">
        <OuiCardBody>
          <OuiStack gap="md" align="center" class="py-12">
            <OuiBox
              class="w-16 h-16 bg-surface-subtle rounded-full flex items-center justify-center"
            >
              <ServerIcon class="h-8 w-8 text-muted" />
            </OuiBox>
            <OuiStack gap="xs" align="center">
              <OuiText size="xl" weight="semibold"
                >Select an Organization</OuiText
              >
              <OuiText
                size="sm"
                color="tertiary"
          ...
          <OuiStack gap="md">
            ...
            <OuiGrid columns="2" gap="md">
              <OuiCard variant="outline">
                <OuiCardBody>
                  <OuiStack gap="sm">
                    <OuiText size="sm" color="tertiary" weight="medium"
                      >Status</OuiText
                    >
                    <OuiBadge
                    ...
                    <OuiBadge v-else variant="secondary" size="md">
                      Not Subscribed
                    </OuiBadge>
                  </OuiStack>
                </OuiCardBody>
            ...
            <OuiText size="sm" color="tertiary" v-if="!hasActiveSubscription">
              Subscribe to enable DNS delegation. Once subscribed, you'll be
              able to create API keys for pushing DNS records from your
      ...
      <OuiCard>
          ...
          <OuiFlex justify="between" align="start">
            ...
            <OuiFlex gap="sm">
              ...
              >
                <ArrowPathIcon
                  class="h-4 w-4 mr-2"
                  :class="{ 'animate-spin': refreshingAPIKey }"
                />
                Refresh
              </OuiButton>
              <OuiButton
        ...
        <OuiCardBody>
          <OuiStack gap="md">
            ...
            <template
              v-else-if="currentAPIKey && currentAPIKey !== '***KEY_EXISTS***'"
            >
                    ...
                    >
                      <OuiFlex align="start" gap="sm">
                        ...
                        <OuiText size="sm">
                          ...
                          securely. It will not be shown again after you leave
                          this page.
                        </OuiText>
                      </OuiFlex>
                    </OuiBox>
                  ...
                  <OuiStack gap="md">
                    ...
                    >
                      <OuiFlex align="start" gap="sm">
                        ...
                        />
                        <OuiText size="sm">
                          The API key value is not displayed for security
                          reasons. If you need a new key, revoke the existing
                  ...
                  <OuiStack gap="md" align="center" class="py-8">
                    ...
                    <OuiStack gap="xs" align="center">
                      ...
                      <OuiText size="sm" color="tertiary" align="center">
                        ...
                        <template v-else>
                          Create an API key to start pushing DNS records from
      ...
      <OuiCard>
        <OuiCardHeader>
          <OuiStack gap="xs">
            ...
            <OuiText size="sm" color="tertiary">
              Use this API key to configure your self-hosted Obiente Cloud API
              to push DNS records.
            </OuiText>
          </OuiStack>
        </OuiCardHeader>
        <OuiCardBody>
          <OuiStack gap="lg">
            ...
            <OuiStack gap="md">
              <OuiText size="sm" weight="semibold"
                >Docker Compose Example</OuiText
              >
              <OuiCode
            ...
            <OuiStack gap="sm">
              <OuiText size="sm" weight="semibold"
                >Testing DNS Resolution</OuiText
              >
              <OuiText size="xs" color="tertiary">
    ...
    <OuiDialog v-model:open="createAPIKeyDialogOpen" title="Create API Key">
      <OuiStack gap="lg">
        <OuiStack gap="xs">
          <OuiText size="sm" color="tertiary">
            Create a new API key for DNS delegation. This will replace any
            existing API key.
          </OuiText>
          <OuiBox
            v-if="error"
          ...
          >
            <OuiFlex align="start" gap="sm">
              <ExclamationTriangleIcon
                class="h-5 w-5 text-danger shrink-0 mt-0.5"
              />
    ...
    <OuiDialog
      v-model:open="cancelSubscriptionDialogOpen"
      title="Cancel Subscription"
    >
      <OuiStack gap="lg">
        <OuiStack gap="xs">
          <OuiText size="sm" color="tertiary">
            Are you sure you want to cancel your DNS delegation subscription?
            Your subscription will remain active until the end of the current
            billing period, then it will be canceled.
          </OuiText>
          <OuiBox
            v-if="error"
            p="md"
        ...
        >
          <OuiFlex align="start" gap="sm">
            ...
            />
            <OuiText size="sm">
              <strong>Important:</strong> After cancellation, your API keys will
              be revoked and DNS delegation will stop working. You can
...
const currentUserIdentifiers = computed(() => {
  ...
  const sessionUser = auth.user as
    | (import("@obiente/types").User & { id?: string; userId?: string })
    | null;
  if (!sessionUser) {
    return identifiers;
  }
...
async function loadSubscriptionStatus() {
  ...
  try {
    ...
    if (response.currentPeriodEnd) {
      const seconds =
        typeof response.currentPeriodEnd.seconds === "bigint"
...
async function subscribeToDNSDelegation() {
  ...
  try {
    ...
    const response =
      await billingClient.createDNSDelegationSubscriptionCheckout({
        organizationId: selectedOrg.value,
        successUrl,
        cancelUrl,
      });
            ...
            const pollInterval = setInterval(async () => {
              ...
              if (hasActiveSubscription.value || pollCount >= maxPolls) {
                ...
                if (hasActiveSubscription.value) {
                  toast.success(
                    "Subscription successful! You can now create an API key."
                  );
                  // Also reload API key status
                  await loadAPIKey();
                } else {
                  toast.warning(
                    "Subscription processing. Please refresh the page in a moment."
                  );
                }
              }
    ...
    error.value =
      (err as Error).message || "Failed to create subscription checkout";
  ...
  try {
    ...
    if (response.success) {
      ...
      if (response.canceledAt) {
        const seconds =
          typeof response.canceledAt.seconds === "bigint"
...
async function loadAPIKey() {
  ...
  try {
    ...
    const statusResponse =
      await billingClient.getDNSDelegationSubscriptionStatus({
        organizationId: selectedOrg.value,
      });
    ...
    if (statusResponse.hasApiKey) {
      ...
      if (statusResponse.apiKeyCreatedAt) {
        ...
        const seconds =
          typeof statusResponse.apiKeyCreatedAt.seconds === "bigint"
...
async function revokeAPIKey() {
  ...
  if (
    !confirm(
      "Are you sure you want to revoke this API key? This will stop DNS delegation from working."
    )
  ) {
    return;
  }
