...
export type UpdateVPSSizeRequest = Message<"obiente.cloud.superadmin.v1.UpdateVPSSizeRequest"> & {
  ...
  /**
   * @generated from field: optional int64 price_cents_per_month = 8;
   */
  priceCentsPerMonth?: bigint;
