...
**NetworkingConfig** | [**NetworkingConfig**](NetworkingConfig.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ContainerCreateRequest } from './api';

const instance: ContainerCreateRequest = {
    Hostname,
    Domainname,
    User,
    AttachStdin,
