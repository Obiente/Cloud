...
export class ContainerBlkioStats {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "ioServiceBytesRecursive",
            "baseName": "io_service_bytes_recursive",
            "type": "Array<ContainerBlkioStatEntry>"
        },
        {
            "name": "ioServicedRecursive",
            "baseName": "io_serviced_recursive",
            "type": "Array<ContainerBlkioStatEntry>"
        },
        {
            "name": "ioQueueRecursive",
            "baseName": "io_queue_recursive",
            "type": "Array<ContainerBlkioStatEntry>"
        },
        {
            "name": "ioServiceTimeRecursive",
            "baseName": "io_service_time_recursive",
            "type": "Array<ContainerBlkioStatEntry>"
        },
        {
            "name": "ioWaitTimeRecursive",
            "baseName": "io_wait_time_recursive",
            "type": "Array<ContainerBlkioStatEntry>"
        },
        {
            "name": "ioMergedRecursive",
            "baseName": "io_merged_recursive",
            "type": "Array<ContainerBlkioStatEntry>"
        },
        {
            "name": "ioTimeRecursive",
            "baseName": "io_time_recursive",
            "type": "Array<ContainerBlkioStatEntry>"
        },
        {
            "name": "sectorsRecursive",
            "baseName": "sectors_recursive",
            "type": "Array<ContainerBlkioStatEntry>"
        }    ];

    static getAttributeTypeMap() {
        return ContainerBlkioStats.attributeTypeMap;
    }
}
