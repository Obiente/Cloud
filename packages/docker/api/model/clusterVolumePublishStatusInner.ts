...
export class ClusterVolumePublishStatusInner {
    ...
    */
    'state'?: ClusterVolumePublishStatusInner.StateEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "State",
            "type": "ClusterVolumePublishStatusInner.StateEnum"
        },
        {
            "name": "publishContext",
            "baseName": "PublishContext",
            "type": "{ [key: string]: string; }"
        }    ];

    static getAttributeTypeMap() {
        return ClusterVolumePublishStatusInner.attributeTypeMap;
    }
}

export namespace ClusterVolumePublishStatusInner {
