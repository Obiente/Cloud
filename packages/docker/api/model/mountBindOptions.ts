...
export class MountBindOptions {
    ...
    */
    'readOnlyNonRecursive'?: boolean = false;
    /**
    * Raise an error if the mount cannot be made recursively read-only.
    */
    'readOnlyForceRecursive'?: boolean = false;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "CreateMountpoint",
            "type": "boolean"
        },
        {
            "name": "readOnlyNonRecursive",
            "baseName": "ReadOnlyNonRecursive",
            "type": "boolean"
        },
        {
            "name": "readOnlyForceRecursive",
            "baseName": "ReadOnlyForceRecursive",
            "type": "boolean"
        }    ];
