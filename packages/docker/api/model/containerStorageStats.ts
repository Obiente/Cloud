...
export class ContainerStorageStats {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "readCountNormalized",
            "baseName": "read_count_normalized",
            "type": "number"
        },
        {
            "name": "readSizeBytes",
            "baseName": "read_size_bytes",
            "type": "number"
        },
        {
            "name": "writeCountNormalized",
            "baseName": "write_count_normalized",
            "type": "number"
        },
        {
            "name": "writeSizeBytes",
            "baseName": "write_size_bytes",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return ContainerStorageStats.attributeTypeMap;
    }
}
