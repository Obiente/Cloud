...
export class ContainerMemoryStats {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "commitbytes",
            "baseName": "commitbytes",
            "type": "number"
        },
        {
            "name": "commitpeakbytes",
            "baseName": "commitpeakbytes",
            "type": "number"
        },
        {
            "name": "privateworkingset",
            "baseName": "privateworkingset",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return ContainerMemoryStats.attributeTypeMap;
    }
}
