...
import { VolumeCreateOptions } from '../model/volumeCreateOptions';
import { VolumeListResponse } from '../model/volumeListResponse';
import { VolumePruneResponse } from '../model/volumePruneResponse';
import { VolumeUpdateRequest } from '../model/volumeUpdateRequest';
...
export class VolumeApi {
     ...
     */
    public async volumeCreate (volumeConfig: VolumeCreateOptions, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Volume;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(volumeConfig, "VolumeCreateOptions")
        };
     ...
     */
    public async volumeUpdate (name: string, version: number, body?: VolumeUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/volumes/{name}'
            .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'name' is not null or undefined
        if (name === null || name === undefined) {
            throw new Error('Required parameter name was null or undefined when calling volumeUpdate.');
        }

        // verify required parameter 'version' is not null or undefined
        if (version === null || version === undefined) {
            throw new Error('Required parameter version was null or undefined when calling volumeUpdate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "VolumeUpdateRequest")
        };
