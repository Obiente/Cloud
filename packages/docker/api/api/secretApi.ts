...
import { SecretCreateRequest } from '../model/secretCreateRequest';
...
export class SecretApi {
     ...
     * @param body 
     */
    public async secretCreate (body?: SecretCreateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IDResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(body, "SecretCreateRequest")
        };
