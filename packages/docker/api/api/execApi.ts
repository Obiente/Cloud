...
export class ExecApi {
     ...
     */
    public async containerExec (id: string, execConfig: ExecConfig, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IDResponse;  }> {
    ...
    public async execResize (id: string, h: number, w: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        if (h === null || h === undefined) {
            throw new Error('Required parameter h was null or undefined when calling execResize.');
        }

        // verify required parameter 'w' is not null or undefined
        if (w === null || w === undefined) {
            throw new Error('Required parameter w was null or undefined when calling execResize.');
        }
     ...
     */
    public async execStart (id: string, execStartConfig?: ExecStartConfig, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/exec/{id}/start'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/vnd.docker.raw-stream', 'application/vnd.docker.multiplexed-stream'];
        // give precedence to 'application/json'
        if (produces.indexOf('application/json') >= 0) {
            localVarHeaderParams.Accept = 'application/json';
        } else {
