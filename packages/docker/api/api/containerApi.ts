...
import { ContainerCreateRequest } from '../model/containerCreateRequest';
...
import { ContainerStatsResponse } from '../model/containerStatsResponse';
import { ContainerSummary } from '../model/containerSummary';
import { ContainerTopResponse } from '../model/containerTopResponse';
import { ContainerUpdateRequest } from '../model/containerUpdateRequest';
...
import { FilesystemChange } from '../model/filesystemChange';
...
export class ContainerApi {
    ...
    public async containerAttach (id: string, detachKeys?: string, logs?: boolean, stream?: boolean, stdin?: boolean, stdout?: boolean, stderr?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/vnd.docker.raw-stream', 'application/vnd.docker.multiplexed-stream', 'application/json'];
        // give precedence to 'application/json'
        if (produces.indexOf('application/json') >= 0) {
            localVarHeaderParams.Accept = 'application/json';
        } else {
     ...
     * @param id ID or name of the container
     */
    public async containerChanges (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<FilesystemChange>;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<FilesystemChange>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<FilesystemChange>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async containerCreate (body: ContainerCreateRequest, name?: string, platform?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerCreateResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "ContainerCreateRequest")
        };
     ...
     */
    public async containerList (all?: boolean, limit?: number, size?: boolean, filters?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<ContainerSummary>;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<ContainerSummary>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<ContainerSummary>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    public async containerResize (id: string, h: number, w: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        if (h === null || h === undefined) {
            throw new Error('Required parameter h was null or undefined when calling containerResize.');
        }

        // verify required parameter 'w' is not null or undefined
        if (w === null || w === undefined) {
            throw new Error('Required parameter w was null or undefined when calling containerResize.');
        }
     ...
     */
    public async containerRestart (id: string, signal?: string, t?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     */
    public async containerStats (id: string, stream?: boolean, oneShot?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerStatsResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ContainerStatsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ContainerStatsResponse");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param t Number of seconds to wait before killing the container
     */
    public async containerStop (id: string, signal?: string, t?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param update 
     */
    public async containerUpdate (id: string, update: ContainerUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerUpdateResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(update, "ContainerUpdateRequest")
        };
     ...
     */
    public async containerWait (id: string, condition?: 'not-running' | 'next-exit' | 'removed', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContainerWaitResponse;  }> {
        ...
        if (condition !== undefined) {
            localVarQueryParameters['condition'] = ObjectSerializer.serialize(condition, "'not-running' | 'next-exit' | 'removed'");
        }
