...
import { ConfigCreateRequest } from '../model/configCreateRequest';
...
export class ConfigApi {
     ...
     * @param body 
     */
    public async configCreate (body?: ConfigCreateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IDResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(body, "ConfigCreateRequest")
        };
