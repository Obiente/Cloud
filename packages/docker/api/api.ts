...
export const ContainerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        containerResize: async (id: string, h: number, w: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('containerResize', 'h', h)
            // verify required parameter 'w' is not null or undefined
            assertParamExists('containerResize', 'w', w)
...
export const ContainerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async containerStats(id: string, stream?: boolean, oneShot?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContainerStatsResponse>> {
...
export const ContainerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        containerStats(id: string, stream?: boolean, oneShot?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<ContainerStatsResponse> {
...
export const ExecApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        execResize: async (id: string, h: number, w: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // verify required parameter 'h' is not null or undefined
            assertParamExists('execResize', 'h', h)
            // verify required parameter 'w' is not null or undefined
            assertParamExists('execResize', 'w', w)
...
export const ImageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} [keepStorage] Amount of disk space in bytes to keep for cache  &gt; **Deprecated**: This parameter is deprecated and has been renamed to \&quot;reserved-space\&quot;. &gt; It is kept for backward compatibility and will be removed in API v1.49. 
         * @param {number} [reservedSpace] Amount of disk space in bytes to keep for cache
         * @param {number} [maxUsedSpace] Maximum amount of disk space allowed to keep for cache
         * @param {number} [minFreeSpace] Target amount of free disk space after pruning
         ...
         * @throws {RequiredError}
         */
        buildPrune: async (keepStorage?: number, reservedSpace?: number, maxUsedSpace?: number, minFreeSpace?: number, all?: boolean, filters?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (reservedSpace !== undefined) {
                localVarQueryParameter['reserved-space'] = reservedSpace;
            }

            if (maxUsedSpace !== undefined) {
                localVarQueryParameter['max-used-space'] = maxUsedSpace;
            }

            if (minFreeSpace !== undefined) {
                localVarQueryParameter['min-free-space'] = minFreeSpace;
            }
         ...
         * @param {Array<string>} [platforms] Select platform-specific content to delete. Multiple values are accepted. Each platform is a OCI platform encoded as a JSON string. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        imageDelete: async (name: string, force?: boolean, noprune?: boolean, platforms?: Array<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            ...
            if (platforms) {
                localVarQueryParameter['platforms'] = platforms.join(COLLECTION_FORMATS.csv);
            }
         ...
         * @param {string} name Image name or ID
         * @param {string} [platform] JSON encoded OCI platform describing a platform which will be used to select a platform-specific image to be saved if the image is multi-platform. If not provided, the full multi-platform image will be saved.  Example: &#x60;{\&quot;os\&quot;: \&quot;linux\&quot;, \&quot;architecture\&quot;: \&quot;arm\&quot;, \&quot;variant\&quot;: \&quot;v5\&quot;}&#x60; 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        imageGet: async (name: string, platform?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        imageGetAll: async (names?: Array<string>, platform?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        imageHistory: async (name: string, platform?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        imageInspect: async (name: string, manifests?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        imageList: async (all?: boolean, filters?: string, sharedSize?: boolean, digests?: boolean, manifests?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} [platform] JSON encoded OCI platform describing a platform which will be used to select a platform-specific image to be load if the image is multi-platform. If not provided, the full multi-platform image will be loaded.  Example: &#x60;{\&quot;os\&quot;: \&quot;linux\&quot;, \&quot;architecture\&quot;: \&quot;arm\&quot;, \&quot;variant\&quot;: \&quot;v5\&quot;}&#x60; 
         * @param {File} [imagesTarball] Tar archive containing images
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        imageLoad: async (quiet?: boolean, platform?: string, imagesTarball?: File, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        imagePush: async (name: string, xRegistryAuth: string, tag?: string, platform?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
...
export const ImageApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async buildPrune(keepStorage?: number, reservedSpace?: number, maxUsedSpace?: number, minFreeSpace?: number, all?: boolean, filters?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BuildPruneResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.buildPrune(keepStorage, reservedSpace, maxUsedSpace, minFreeSpace, all, filters, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async imageDelete(name: string, force?: boolean, noprune?: boolean, platforms?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ImageDeleteResponseItem>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.imageDelete(name, force, noprune, platforms, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async imageGet(name: string, platform?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.imageGet(name, platform, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async imageGetAll(names?: Array<string>, platform?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.imageGetAll(names, platform, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async imageHistory(name: string, platform?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<HistoryResponseItem>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.imageHistory(name, platform, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async imageInspect(name: string, manifests?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImageInspect>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.imageInspect(name, manifests, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async imageList(all?: boolean, filters?: string, sharedSize?: boolean, digests?: boolean, manifests?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ImageSummary>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.imageList(all, filters, sharedSize, digests, manifests, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async imageLoad(quiet?: boolean, platform?: string, imagesTarball?: File, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.imageLoad(quiet, platform, imagesTarball, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async imagePush(name: string, xRegistryAuth: string, tag?: string, platform?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.imagePush(name, xRegistryAuth, tag, platform, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ImageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        buildPrune(keepStorage?: number, reservedSpace?: number, maxUsedSpace?: number, minFreeSpace?: number, all?: boolean, filters?: string, options?: RawAxiosRequestConfig): AxiosPromise<BuildPruneResponse> {
            return localVarFp.buildPrune(keepStorage, reservedSpace, maxUsedSpace, minFreeSpace, all, filters, options).then((request) => request(axios, basePath));
        },
        /**
         * Build an image from a tar archive with a `Dockerfile` in it.  The `Dockerfile` specifies how the image is built from the tar archive. It is typically in the archive\'s root, but can be at a different path or have a different name by specifying the `dockerfile` parameter. [See the `Dockerfile` reference for more information](https://docs.docker.com/engine/reference/builder/).  The Docker daemon performs a preliminary validation of the `Dockerfile` before starting the build, and returns an error if the syntax is incorrect. After that, each instruction is run one-by-one until the ID of the new image is output.  The build is canceled if the client drops the connection by quitting or being killed. 
         * @summary Build an image
         ...
         * @throws {RequiredError}
         */
        imageDelete(name: string, force?: boolean, noprune?: boolean, platforms?: Array<string>, options?: RawAxiosRequestConfig): AxiosPromise<Array<ImageDeleteResponseItem>> {
            return localVarFp.imageDelete(name, force, noprune, platforms, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a tarball containing all images and metadata for a repository.  If `name` is a specific name and tag (e.g. `ubuntu:latest`), then only that image (and its parents) are returned. If `name` is an image ID, similarly only that image (and its parents) are returned, but with the exclusion of the `repositories` file in the tarball, as there were no image names referenced.  ### Image tarball format  An image tarball contains [Content as defined in the OCI Image Layout Specification](https://github.com/opencontainers/image-spec/blob/v1.1.1/image-layout.md#content).  Additionally, includes the manifest.json file associated with a backwards compatible docker save format.  If the tarball defines a repository, the tarball should also include a `repositories` file at the root that contains a list of repository and tag names mapped to layer IDs.  ```json {   \"hello-world\": {     \"latest\": \"565a9d68a73f6706862bfe8409a7f659776d4d60a8d096eb4a3cbce6999cc2a1\"   } } ``` 
         * @summary Export an image
         ...
         * @throws {RequiredError}
         */
        imageGet(name: string, platform?: string, options?: RawAxiosRequestConfig): AxiosPromise<File> {
            return localVarFp.imageGet(name, platform, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a tarball containing all images and metadata for several image repositories.  For each value of the `names` parameter: if it is a specific name and tag (e.g. `ubuntu:latest`), then only that image (and its parents) are returned; if it is an image ID, similarly only that image (and its parents) are returned and there would be no names referenced in the \'repositories\' file for this image ID.  For details on the format, see the [export image endpoint](#operation/ImageGet). 
         * @summary Export several images
         ...
         * @throws {RequiredError}
         */
        imageGetAll(names?: Array<string>, platform?: string, options?: RawAxiosRequestConfig): AxiosPromise<File> {
            return localVarFp.imageGetAll(names, platform, options).then((request) => request(axios, basePath));
        },
        /**
         * Return parent layers of an image.
         * @summary Get the history of an image
         ...
         * @throws {RequiredError}
         */
        imageHistory(name: string, platform?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<HistoryResponseItem>> {
            return localVarFp.imageHistory(name, platform, options).then((request) => request(axios, basePath));
        },
        /**
         * Return low-level information about an image.
         * @summary Inspect an image
         ...
         * @throws {RequiredError}
         */
        imageInspect(name: string, manifests?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<ImageInspect> {
            return localVarFp.imageInspect(name, manifests, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a list of images on the server. Note that it uses a different, smaller representation of an image than inspecting a single image.
         * @summary List Images
         ...
         * @throws {RequiredError}
         */
        imageList(all?: boolean, filters?: string, sharedSize?: boolean, digests?: boolean, manifests?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<Array<ImageSummary>> {
            return localVarFp.imageList(all, filters, sharedSize, digests, manifests, options).then((request) => request(axios, basePath));
        },
        /**
         * Load a set of images and tags into a repository.  For details on the format, see the [export image endpoint](#operation/ImageGet). 
         * @summary Import images
         ...
         * @throws {RequiredError}
         */
        imageLoad(quiet?: boolean, platform?: string, imagesTarball?: File, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.imageLoad(quiet, platform, imagesTarball, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Delete unused images
         ...
         * @throws {RequiredError}
         */
        imagePush(name: string, xRegistryAuth: string, tag?: string, platform?: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.imagePush(name, xRegistryAuth, tag, platform, options).then((request) => request(axios, basePath));
        },
        /**
         * Search for an image on Docker Hub.
         * @summary Search images
...
export class ImageApi extends BaseAPI {
     ...
     * @memberof ImageApi
     */
    public buildPrune(keepStorage?: number, reservedSpace?: number, maxUsedSpace?: number, minFreeSpace?: number, all?: boolean, filters?: string, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).buildPrune(keepStorage, reservedSpace, maxUsedSpace, minFreeSpace, all, filters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImageApi
     */
    public imageDelete(name: string, force?: boolean, noprune?: boolean, platforms?: Array<string>, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).imageDelete(name, force, noprune, platforms, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImageApi
     */
    public imageGet(name: string, platform?: string, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).imageGet(name, platform, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImageApi
     */
    public imageGetAll(names?: Array<string>, platform?: string, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).imageGetAll(names, platform, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImageApi
     */
    public imageHistory(name: string, platform?: string, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).imageHistory(name, platform, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImageApi
     */
    public imageInspect(name: string, manifests?: boolean, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).imageInspect(name, manifests, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImageApi
     */
    public imageList(all?: boolean, filters?: string, sharedSize?: boolean, digests?: boolean, manifests?: boolean, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).imageList(all, filters, sharedSize, digests, manifests, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImageApi
     */
    public imageLoad(quiet?: boolean, platform?: string, imagesTarball?: File, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).imageLoad(quiet, platform, imagesTarball, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ImageApi
     */
    public imagePush(name: string, xRegistryAuth: string, tag?: string, platform?: string, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).imagePush(name, xRegistryAuth, tag, platform, options).then((request) => request(this.axios, this.basePath));
    }
